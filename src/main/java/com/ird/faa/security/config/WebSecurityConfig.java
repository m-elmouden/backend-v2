...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/comptable/login").permitAll();
        http.authorizeRequests().antMatchers("/api/societe/login").permitAll();
        ...
        http.authorizeRequests().antMatchers("/api/comptable/").hasAnyAuthority(AuthoritiesConstants.COMPTABLE);
        http.authorizeRequests().antMatchers("/api/societe/").hasAnyAuthority(AuthoritiesConstants.SOCIETE);
