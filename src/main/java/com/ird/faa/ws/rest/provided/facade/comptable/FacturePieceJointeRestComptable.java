...
import com.ird.faa.service.comptable.facade.FacturePieceJointeComptableService;
...
@RestController
@RequestMapping("api/comptable/facturePieceJointe")
public class FacturePieceJointeRestComptable {

    @Autowired
    private FacturePieceJointeComptableService facturePieceJointeService;
