...
import com.ird.faa.service.chercheur.facade.TypeEmployeChercheurService;
...
@RestController
@RequestMapping("api/chercheur/typeEmploye")
public class TypeEmployeRestChercheur {

@Autowired
private TypeEmployeChercheurService typeEmployeService;
