...
DeclarationIrEmploye item = new DeclarationIrEmploye();
        ...
        item.setindemniteJustifie(NumberUtil.toBigDecimal(vo.getIndemnite()));
        if(StringUtil.isNotEmpty(vo.getPrimes()))
        item.setPrimes(NumberUtil.toBigDecimal(vo.getPrimes()));
    ...
    if(vo.getTauxIrVo()!=null && this.tauxIr)
...
DeclarationIrEmployeVo vo = new DeclarationIrEmployeVo();
        ...
        if(item.getSalaireBase()!=null)
        vo.setSalaireBase(NumberUtil.toString(item.getSalaireBase()));

        if(item.getindemniteJustifie()!=null)
        vo.setIndemnite(NumberUtil.toString(item.getindemniteJustifie()));

        if(item.getPrimes()!=null)
        vo.setPrimes(NumberUtil.toString(item.getPrimes()));
