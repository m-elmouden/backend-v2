...
@RestController
@RequestMapping("api/comptable/declarationIr")
public class DeclarationIrRestComptable {
    ...
    public List<DeclarationIrVo> findAll() {
        societeConverter.setDeclarationIrs(false);
        List<DeclarationIrVo> declarationIrVoList = declarationIrConverter.toVo(declarationIrService.findAll());
        societeConverter.setDeclarationIrs(true);
    ...
    public List<DeclarationIrVo> findByEtatDeclarationIrReference(@PathVariable String reference) {
        List<DeclarationIrVo> List = declarationIrConverter.toVo(declarationIrService.findByEtatDeclarationIrReference(reference));
        return List;
    }
