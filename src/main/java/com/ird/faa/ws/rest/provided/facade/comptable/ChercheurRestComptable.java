...
import com.ird.faa.service.comptable.facade.ChercheurComptableService;
...
@RestController
@RequestMapping("api/comptable/chercheur")
public class ChercheurRestComptable {

@Autowired
private ChercheurComptableService chercheurService;
