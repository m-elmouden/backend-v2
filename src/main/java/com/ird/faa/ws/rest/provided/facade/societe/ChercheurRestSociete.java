...
import com.ird.faa.service.societe.facade.ChercheurSocieteService;
...
@RestController
@RequestMapping("api/societe/chercheur")
public class ChercheurRestSociete {

    @Autowired
    private ChercheurSocieteService chercheurService;
