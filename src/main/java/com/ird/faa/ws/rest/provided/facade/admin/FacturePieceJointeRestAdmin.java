...
import com.ird.faa.service.admin.facade.FacturePieceJointeAdminService;
...
@RestController
@RequestMapping("api/admin/facturePieceJointe")
public class FacturePieceJointeRestAdmin {

    @Autowired
    private FacturePieceJointeAdminService facturePieceJointeService;
