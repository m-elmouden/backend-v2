...
@Service
public class PaiementDeclarationIrComptableServiceImpl extends AbstractServiceImpl<PaiementDeclarationIr> implements PaiementDeclarationIrComptableService {
