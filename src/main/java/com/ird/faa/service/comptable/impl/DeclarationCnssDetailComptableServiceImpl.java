...
@Service
public class DeclarationCnssDetailComptableServiceImpl extends AbstractServiceImpl<DeclarationCnssDetail> implements DeclarationCnssDetailComptableService {
