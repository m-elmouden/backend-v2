...
@Service
public class TypeOperationFactureComptableServiceImpl extends AbstractServiceImpl<TypeOperationFacture> implements TypeOperationFactureComptableService {
