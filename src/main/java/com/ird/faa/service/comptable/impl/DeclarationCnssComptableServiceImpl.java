...
@Service
public class DeclarationCnssComptableServiceImpl extends AbstractServiceImpl<DeclarationCnss> implements DeclarationCnssComptableService {
    ...
    @Autowired
    private DeclarationCnssDetailComptableService declarationCnssDetailService;
