...
import com.ird.faa.service.comptable.facade.DeclarationIrComptableService;
        ...
        import com.ird.faa.service.comptable.facade.PaiementDeclarationIrComptableService;
...
@Service
public class DeclarationIrComptableServiceImpl extends AbstractServiceImpl<DeclarationIr> implements DeclarationIrComptableService {
...
private DeclarationIrDao declarationIrDao;
    ...
    private ArchivableService<DeclarationIr> archivableService;
        ...
        @Autowired
        private PaiementDeclarationIrComptableService paiementDeclarationIrService ;
        @Autowired
        private EtatDeclarationIrComptableService etatDeclarationIrService ;
        @Autowired
        private DeclarationIrEmployeComptableService declarationIrEmployeService ;
        @Autowired
