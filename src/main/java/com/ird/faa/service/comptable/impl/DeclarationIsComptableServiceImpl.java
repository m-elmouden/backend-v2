...
import com.ird.faa.service.comptable.facade.DeclarationIsComptableService;
        ...
        import com.ird.faa.service.comptable.facade.PaiementDeclarationIsComptableService;
...
@Service
public class DeclarationIsComptableServiceImpl extends AbstractServiceImpl<DeclarationIs> implements DeclarationIsComptableService {
...
private DeclarationIsDao declarationIsDao;
    ...
    private ArchivableService<DeclarationIs> archivableService;
        ...
        @Autowired
        private PaiementDeclarationIsComptableService paiementDeclarationIsService ;
