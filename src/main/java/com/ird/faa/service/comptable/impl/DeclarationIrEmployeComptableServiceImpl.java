...
import com.ird.faa.service.comptable.facade.DeclarationIrEmployeComptableService;
        import com.ird.faa.service.comptable.facade.TauxIrComptableService;
...
@Service
public class DeclarationIrEmployeComptableServiceImpl extends AbstractServiceImpl<DeclarationIrEmploye> implements DeclarationIrEmployeComptableService {

@Autowired
private DeclarationIrEmployeDao declarationIrEmployeDao;

        @Autowired
        private TauxIrComptableService tauxIrService ;
        @Autowired
