...
import com.ird.faa.service.admin.facade.TypeTauxCnssAdminService;
...
@Service
public class DeclarationCnssDetailAdminServiceImpl extends AbstractServiceImpl<DeclarationCnssDetail> implements DeclarationCnssDetailAdminService {
    ...
    @Autowired
    private TypeTauxCnssAdminService typeTauxCnssService;
    @Autowired
    private DeclarationCnssAdminService declarationCnssService;
