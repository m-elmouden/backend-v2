...
import com.ird.faa.service.admin.facade.EtatFactureAdminService;
...
@Service
public class EtatFactureAdminServiceImpl extends AbstractServiceImpl<EtatFacture> implements EtatFactureAdminService {
