...
@Service
public class DeclarationIsAdminServiceImpl extends AbstractServiceImpl<DeclarationIs> implements DeclarationIsAdminService {
...
private DeclarationIsDao declarationIsDao;
    ...
    private ArchivableService<DeclarationIs> archivableService;
        ...
        @Autowired
        private EtatDeclarationIsAdminService etatDeclarationIsService ;
        @Autowired
