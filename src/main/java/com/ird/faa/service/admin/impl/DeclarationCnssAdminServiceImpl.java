...
import com.ird.faa.service.admin.facade.DeclarationCnssAdminService;
        import com.ird.faa.service.admin.facade.SocieteAdminService;
        import com.ird.faa.service.admin.facade.EmployeAdminService;
        import com.ird.faa.service.admin.facade.DeclarationCnssDetailAdminService;
...
@Service
public class DeclarationCnssAdminServiceImpl extends AbstractServiceImpl<DeclarationCnss> implements DeclarationCnssAdminService {
...
private DeclarationCnssDao declarationCnssDao;
    ...
    private ArchivableService<DeclarationCnss> archivableService;
        ...
        @Autowired
        private DeclarationCnssDetailAdminService declarationCnssDetailService ;
...
public List<DeclarationCnss> findAll(){
        return declarationCnssDao.findAll();
}
...
public DeclarationCnss findByIdWithAssociatedList(Long id){
    ...
    @Override
    public DeclarationCnss archiver(DeclarationCnss declarationCnss) {
    if (declarationCnss.getArchive() == null) {
    declarationCnss.setArchive(false);
    }
    declarationCnss.setArchive(true);
    declarationCnss.setDateArchivage(new Date());
    declarationCnssDao.save(declarationCnss);
    return declarationCnss;

    }

    @Override
    public DeclarationCnss desarchiver(DeclarationCnss declarationCnss) {
    if (declarationCnss.getArchive() == null) {
    declarationCnss.setArchive(false);
    }
    declarationCnss.setArchive(false);
    declarationCnss.setDateArchivage(null);
    declarationCnssDao.save(declarationCnss);
    return declarationCnss;
    }
