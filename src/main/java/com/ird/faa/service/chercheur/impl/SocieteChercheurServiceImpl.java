...
import com.ird.faa.service.chercheur.facade.SocieteChercheurService;
        import com.ird.faa.service.chercheur.facade.TypeSocieteChercheurService;
        ...
        import com.ird.faa.service.chercheur.facade.PresidentSocieteChercheurService;
        ...
        import com.ird.faa.service.chercheur.facade.ComptableChercheurService;
...
@Service
public class SocieteChercheurServiceImpl extends AbstractServiceImpl<Societe> implements SocieteChercheurService {

@Autowired
private SocieteDao societeDao;

        @Autowired
        private TypeSocieteChercheurService typeSocieteService ;
        @Autowired
        private DeclarationTvaChercheurService declarationTvaService ;
        @Autowired
        private AcompteChercheurService acompteService ;
        @Autowired
        private PresidentSocieteChercheurService presidentSocieteService ;
        @Autowired
        private DemandeChercheurService demandeService ;
        @Autowired
        private FactureChercheurService factureService ;
        @Autowired
        private DeclarationCnssChercheurService declarationCnssService ;
        @Autowired
        private DeclarationIsChercheurService declarationIsService ;
        @Autowired
        private DeclarationIrChercheurService declarationIrService ;
        @Autowired
        private EmployeChercheurService employeService ;
        @Autowired
        private ComptableChercheurService comptableService ;
