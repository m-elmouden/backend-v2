...
@Service
public class TypeOperationFactureChercheurServiceImpl extends AbstractServiceImpl<TypeOperationFacture> implements TypeOperationFactureChercheurService {
