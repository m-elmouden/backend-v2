...
import com.ird.faa.service.chercheur.facade.DeclarationTvaChercheurService;
        ...
        import com.ird.faa.service.chercheur.facade.PaiementDeclarationTvaChercheurService;
        import com.ird.faa.service.chercheur.facade.EtatDeclarationTvaChercheurService;
        import com.ird.faa.service.chercheur.facade.TypeDeclarationTvaChercheurService;
...
@Service
public class DeclarationTvaChercheurServiceImpl extends AbstractServiceImpl<DeclarationTva> implements DeclarationTvaChercheurService {
...
private DeclarationTvaDao declarationTvaDao;
    ...
    private ArchivableService<DeclarationTva> archivableService;
        ...
        @Autowired
        private PaiementDeclarationTvaChercheurService paiementDeclarationTvaService ;
        @Autowired
        private EtatDeclarationTvaChercheurService etatDeclarationTvaService ;
        @Autowired
        private TypeDeclarationTvaChercheurService typeDeclarationTvaService ;
...
public List<DeclarationTva> findAll(){
    List<DeclarationTva> resultat= new ArrayList();
...
return  declarationTvaDao.save(declarationTva);
    ...
    private void prepareSave(DeclarationTva declarationTva){
        declarationTva.setDateCreation(new Date());
            ...
            declarationTva.setUsername(currentUser.getUsername());
            }
...
declarationTvas.forEach(e->declarationTvaDao.save(e));
        ...
        public List<DeclarationTva> findAllNonArchive(){
        String query = "SELECT o FROM DeclarationTva o  WHERE o.archive != true AND o.visible = true";
        return entityManager.createQuery(query).getResultList();
        }

        public List<DeclarationTva> findAllByOwner(){
        List<DeclarationTva> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM DeclarationTva o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
