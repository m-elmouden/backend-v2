...
import com.ird.faa.service.chercheur.facade.DeclarationIsChercheurService;
        ...
        import com.ird.faa.service.chercheur.facade.TauxIsConfigChercheurService;
        import com.ird.faa.service.chercheur.facade.TauxIsChercheurService;
        import com.ird.faa.service.chercheur.facade.PaiementDeclarationIsChercheurService;
...
@Service
public class DeclarationIsChercheurServiceImpl extends AbstractServiceImpl<DeclarationIs> implements DeclarationIsChercheurService {
...
private DeclarationIsDao declarationIsDao;
    ...
    private ArchivableService<DeclarationIs> archivableService;
        ...
        @Autowired
        private EtatDeclarationIsChercheurService etatDeclarationIsService ;
        @Autowired
        private TauxIsConfigChercheurService tauxIsConfigService ;
        @Autowired
        private TauxIsChercheurService tauxIsService ;
        @Autowired
        private PaiementDeclarationIsChercheurService paiementDeclarationIsService ;
...
public List<DeclarationIs> findAll(){
    List<DeclarationIs> resultat= new ArrayList();
...
return  declarationIsDao.save(declarationIs);
    ...
    private void prepareSave(DeclarationIs declarationIs){
        declarationIs.setDateCreation(new Date());
            ...
            declarationIs.setUsername(currentUser.getUsername());
            }
...
declarationIss.forEach(e->declarationIsDao.save(e));
        ...
        public List<DeclarationIs> findAllNonArchive(){
        String query = "SELECT o FROM DeclarationIs o  WHERE o.archive != true AND o.visible = true";
        return entityManager.createQuery(query).getResultList();
        }

        public List<DeclarationIs> findAllByOwner(){
        List<DeclarationIs> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM DeclarationIs o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
