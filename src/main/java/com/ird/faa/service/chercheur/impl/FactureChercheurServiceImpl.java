...
import com.ird.faa.service.chercheur.facade.FactureChercheurService;
        ...
        import com.ird.faa.service.chercheur.facade.ClasseComptableChercheurService;
        ...
        import com.ird.faa.service.chercheur.facade.TvaChercheurService;
...
@Service
public class FactureChercheurServiceImpl extends AbstractServiceImpl<Facture> implements FactureChercheurService {
...
private FactureDao factureDao;
    ...
    private ArchivableService<Facture> archivableService;
        ...
        @Autowired
        private ClasseComptableChercheurService classeComptableService ;
        @Autowired
        ...
        @Autowired
        private TvaChercheurService tvaService ;
...
return  factureDao.save(facture);
    ...
    private void prepareSave(Facture facture){
        facture.setDateCreation(new Date());
            ...
            facture.setUsername(currentUser.getUsername());
            }
...
factures.forEach(e->factureDao.save(e));
        ...
        public List<Facture> findAllNonArchive(){
        String query = "SELECT o FROM Facture o  WHERE o.archive != true AND o.visible = true";
            query+= " ORDER BY o.dateOperation";
        return entityManager.createQuery(query).getResultList();
        }

        public List<Facture> findAllByOwner(){
        List<Facture> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM Facture o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
            query+= " ORDER BY o.dateOperation";
