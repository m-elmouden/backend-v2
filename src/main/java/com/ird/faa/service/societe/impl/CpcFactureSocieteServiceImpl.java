...
@Service
public class CpcFactureSocieteServiceImpl extends AbstractServiceImpl<CpcFacture> implements CpcFactureSocieteService {

@Autowired
private CpcFactureDao cpcFactureDao;

        @Autowired
        private CpcSocieteService cpcService ;
        @Autowired
